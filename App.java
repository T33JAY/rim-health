...
public class App {
    ...
    public static int inputChecker(int firstOption, int lastOption) {
        ...
        do {
        	...
        	System.out.print("Please type option number here: ");
        ...
        switch (response) {
            ...
            case 2: //Doctor
            	...
            	while (true) {
                    ...
                    if (doctorPassword.equals("ValarMorghulis")) {
            ...
            case 3: //Admin
                ...
                while (true) {
                    ...
                    if (adminPassword.equals("EarthIsFlat")) {
                    	...
                    	@SuppressWarnings("unused")
                    	Admin newAdmin = new Admin(adminName);
        ...
        switch (response) {
            	...
            	case 1:
            		...
            		case 1:
            			...
            			if(appointments.isEmpty()) {
            				...
            				System.out.println("No appointments have been made yet.");
            ...
            case 3:
            	...
            	case 1:
            		...
            		System.out.println("What type of ward would you like to assign to the patient? Type here: ");
            	...
            	case 2:
            		...
            		System.out.print("Enter the ID of nurse here: ");
            	...
            	case 3:
            		...
            		for (@SuppressWarnings("unused") Surgeon surgeon : surgeons) {
                            
            			System.out.println(surgeons.toString());
                        
            		}
                        
            		System.out.print("Enter the ID of surgeon here: ");
